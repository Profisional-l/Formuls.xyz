...
//           // Если найден в кэше, вернем из кэша
//           if (response) {
//             return response;
//           }

//           // Если не найден, выполним запрос в сеть
//           return fetch(event.request).then(function(fetchResponse) {
//             // Проверим, что получили успешный ответ
...
//           // В случае ошибки, пытаемся вернуть ресурс из кэша
